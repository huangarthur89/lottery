...
st.markdown("""
    ...
    .fengshui-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 6px; width: 100%; max-width: 600px; margin: 15px auto; aspect-ratio: 1; font-family: "MingLiU", "PMingLiU", "Noto Serif TC", serif;}
