...
st.markdown("""
    ...
    div[data-testid="column"]:nth-of-type(1) div[data-testid="stVerticalBlock"] > div:nth-child(1) button p::after {
    ...
    div[data-testid="column"]:nth-of-type(1) div[data-testid="stVerticalBlock"] > div:nth-child(3) button p::after {
        content: "雙區智能健檢\\A頭獎大數據回測";
        white-space: pre-wrap; font-size: 16px !important; font-weight: 500 !important; margin-top: 12px; color: #EEEEEE; line-height: 1.5;
    }
    ...
    div[data-testid="column"]:nth-of-type(2) div[data-testid="stVerticalBlock"] > div:nth-child(1) button p::after {
        content: "歷史數據監測\\A冷熱號碼統計";
        white-space: pre-wrap; font-size: 16px !important; font-weight: 500 !important; margin-top: 12px; color: #EEEEEE; line-height: 1.5;
    }
    ...
    div[data-testid="column"]:nth-of-type(2) div[data-testid="stVerticalBlock"] > div:nth-child(3) button p::after {
...
with col1:
    # Python 程式碼中只傳入「主標題」，防範系統惡意改寫文字
    if st.button("🔮 命盤分析", use_container_width=True):
        st.switch_page("pages/1_命盤分析.py")
    st.markdown("<br>", unsafe_allow_html=True)
    if st.button("🎰 威力彩分析", use_container_width=True):
        st.switch_page("pages/3_威力彩分析.py")

with col2:
    if st.button("📊 大樂透分析", use_container_width=True):
